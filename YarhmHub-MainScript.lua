...
Converted["_UICorner9"].Parent = Converted["_AddCustomModule"]
...
Converted["_UICorner10"].Parent = Converted["_TextBox1"]
...
Converted["_UICorner11"].Parent = Converted["_Add"]
...
Converted["_UICorner12"].Parent = Converted["_Cancel"]
...
Converted["_UICorner13"].Parent = Converted["_Menu"]
...
Converted["_UICorner15"].Parent = Converted["_Frame1"]
...
Converted["_UICorner16"].Parent = Converted["_TextLabel5"]
...
Converted["_TextLabel6"].Text = "ur just a gaemboi"
...
Converted["_TextLabel8"].Text = "(stan katseye)"
Converted["_TextLabel8"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_TextLabel8"].TextSize = 9
Converted["_TextLabel8"].TextTransparency = 0.699999988079071
...
Converted["_TextLabel8"].Position = UDim2.new(0.4923051, 0, 0.559619009, 0)
Converted["_TextLabel8"].Size = UDim2.new(0, 200, 0, 50)
Converted["_TextLabel8"].Parent = Converted["_Area1"]
Converted["_UICorner17"].Parent = Converted["_Area"]
...
Converted["_UICorner18"].Parent = Converted["_List"]
...
Converted["_UICorner19"].Parent = Converted["_AddCustomModule1"]
...
Converted["_UICorner21"].Parent = Converted["_Toggler"]
...
Converted["_UICorner22"].CornerRadius = UDim.new(0, 10)
Converted["_UICorner22"].Parent = Converted["_NotificationSample"]
...
Converted["_TextLabel11"].Position = UDim2.new(-0.0633024424, 0, 0.685714304, 0)
Converted["_TextLabel11"].Size = UDim2.new(0, 125, 1, 0)
Converted["_TextLabel11"].Parent = Converted["_Range"]
...
Converted["_UICorner26"].Parent = Converted["_Frame4"]
...
Converted["_UICorner27"].Parent = Converted["_Track"]
...
Converted["_UICorner28"].Parent = Converted["_Ball"]
...
Converted["_UICorner29"].Parent = Converted["_Visibility"]
...
Converted["_UICorner30"].Parent = Converted["_Lock1"]
...
Converted["_UICorner31"].Parent = Converted["_Exit"]
...
local function ZVJMOK_routine() -- Script: StarterGui.YARHM.Flee the Facility
...
local function BYVMH_routine() -- Script: StarterGui.YARHM.Universal
    local script = Instance.new("LocalScript")
...
local function VFKZNVN_routine() -- Script: StarterGui.YARHM.Init
	local script = Instance.new("LocalScript")
	script.Name = "Init"
	script.Parent = Converted["_YARHM"]
	local req = require
...
local function WGUQQC_routine() -- Script: StarterGui.YARHM.Forsaken
	local script = Instance.new("LocalScript")
...
local function ULIKGUX_routine() -- Script: StarterGui.YARHM.Murder Mystery 2
	local script = Instance.new("LocalScript")
...
local function VWQEM_routine() -- Script: StarterGui.YARHM.Open.InitOpen
	local script = Instance.new("LocalScript")
...
local function DJHQON_routine() -- Script: StarterGui.YARHM.Open.OnClick
	local script = Instance.new("LocalScript")
	script.Name = "OnClick"
	script.Parent = Converted["_Open"]
	local req = require
...
local function HDLRKH_routine() -- Script: StarterGui.YARHM.Open.Resizer
	local script = Instance.new("LocalScript")
	script.Name = "Resizer"
	script.Parent = Converted["_Open"]
	local req = require
...
local function DBSMGV_routine() -- Script: StarterGui.YARHM.FloatingButton.Keybinding
	local script = Instance.new("LocalScript")
...
local function TUPUOZS_routine() -- Script: StarterGui.YARHM.FloatingButton.Invisible
	local script = Instance.new("LocalScript")
...
local function GCEC_routine() -- Script: StarterGui.YARHM.AddCustomModule.Add.LocalScript
	local script = Instance.new("LocalScript")
...
local function EAAE_routine() -- Script: StarterGui.YARHM.AddCustomModule.Cancel.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function TEBO_routine() -- Script: StarterGui.YARHM.Menu.UIStroke.UIGradient.Animator
	local script = Instance.new("LocalScript")
...
local function EWIJ_routine() -- Script: StarterGui.YARHM.Menu.CloseArea.CloseOpen
	local script = Instance.new("LocalScript")
	...
	MenuDrag.DragEnded = function(vel)
		...
		if math.abs(vel.Y) > 10 then
			...
			task.spawn(function() task.wait(0.25) menu.List.Visible = false end)
			menu.CanvasGroup.Visible = true
			OpenerDraggable = true
			if closing then closing:Cancel() end
			TweenService:Create(menu.CanvasGroup, TweenInfo.new(0.5, Enum.EasingStyle.Cubic, Enum.EasingDirection.Out), {
...
local function VWZS_routine() -- Script: StarterGui.YARHM.Menu.List.AutoSetup
	local script = Instance.new("LocalScript")
...
local function OSOFTXX_routine() -- Script: StarterGui.YARHM.Menu.List.AddCustomModule.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function LCFXZS_routine() -- Script: StarterGui.YARHM.FloatingButtonSetting.ControlBarContainer.ControlBar.Visibility.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function HZMLDEI_routine() -- Script: StarterGui.YARHM.FloatingButtonSetting.ControlBarContainer.ControlBar.Lock.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
local function ADLREI_routine() -- Script: StarterGui.YARHM.FloatingButtonSetting.ControlBarContainer.ControlBar.Exit.LocalScript
	local script = Instance.new("LocalScript")
	script.Name = "LocalScript"
...
coroutine.wrap(ZVJMOK_routine)()
coroutine.wrap(BYVMH_routine)()
coroutine.wrap(VFKZNVN_routine)()
coroutine.wrap(WGUQQC_routine)()
coroutine.wrap(ULIKGUX_routine)()
coroutine.wrap(VWQEM_routine)()
coroutine.wrap(DJHQON_routine)()
coroutine.wrap(HDLRKH_routine)()
coroutine.wrap(DBSMGV_routine)()
coroutine.wrap(TUPUOZS_routine)()
coroutine.wrap(GCEC_routine)()
coroutine.wrap(EAAE_routine)()
coroutine.wrap(TEBO_routine)()
coroutine.wrap(EWIJ_routine)()
coroutine.wrap(VWZS_routine)()
coroutine.wrap(OSOFTXX_routine)()
coroutine.wrap(LCFXZS_routine)()
coroutine.wrap(HZMLDEI_routine)()
coroutine.wrap(ADLREI_routine)()
...
game:HttpGet("https://yarhm.mhi.im/analytics?a-reading=YARHM&a-game=" .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name .. "&a-gameId=" .. game.PlaceId .. "&a-uqid=" .. usrId .. "&a-exec=" .. (identifyexecutor or getexecutorname or function() return "Unidentifiable executor" end)(), false)