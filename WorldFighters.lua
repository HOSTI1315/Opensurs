        ...
        task.spawn(function()
            while getgenv().AutoSkillTree and not stopped do
                ...
                for treeName, enabled in pairs(getgenv().SkillTreeSelection or {}) do
                    ...
                    if type(nodes) ~= "table" then goto continue end
                    ...
                    for pass = 1, 10 do
                        ...
                        for nodeName, nodeData in pairs(nodes) do
                            if type(nodeName) ~= "string" then goto nodecontinue end
                            if isNodeUnlocked(treeName, nodeName) then goto nodecontinue end
