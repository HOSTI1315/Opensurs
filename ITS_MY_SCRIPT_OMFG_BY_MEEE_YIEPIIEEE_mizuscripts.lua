-- [[ MADE BY MIZUMARU | discord.gg/mxSvSpJe7s ]]
-- [[ MADE BY MIZUMARU | discord.gg/mxSvSpJe7s ]]
-- [[ MADE BY MIZUMARU | discord.gg/mxSvSpJe7s ]]
-- [[ MADE BY MIZUMARU | discord.gg/mxSvSpJe7s ]]
-- [[ MADE BY MIZUMARU | discord.gg/mxSvSpJe7s ]]
...
-- [[ THIS IS MY SCRIPT , IF SCRIPT NOT WORKING, ASK AI TO FIX THE SH1T SCRIPT / J これは私の脚本です!! ;3 ]]
...
-- スタック状態を確認し、指定時間を超えてスタックしている場合は再起動する機能。
task.spawn(function()
    pcall(function()
        local OutTick = 0
        local StuckCount = 0
...
-- アイテム名が指定されたキーワードと一致するかどうかを確認する機能。
...
if tonumber(game.PlaceId) == 79546208627805 then
    -- *** ゲームのコード PlaceId 79546208627805 ***
    ...
    title2.Text = "Auto-Farm Gem | MIZUHUB"
    ...
    -- しばらく待ってからゲームを再起動してください。(もしこれを読んでいたら、私は @mizuscripts です)
    task.wait(2)
