...
KeySystemGUI1.Parent = game.Players.LocalPlayer.PlayerGui
...
Backdrop2.BackgroundTransparency = 1.000000
...
UIGradient10.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(85,0,255)), ColorSequenceKeypoint.new(0.500000, Color3.fromRGB(171,0,255)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(85,0,255))})
...
UIGradient17.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(114,137,218)), ColorSequenceKeypoint.new(0.500000, Color3.fromRGB(88,101,242)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(114,137,218))})
...
ImageLabel18.Image = "rbxassetid://83378893125739"
...
TextLabel21.Text = "Xenith Hub - KeySys"
TextLabel21.TextColor3 = Color3.fromRGB(220,220,225)
TextLabel21.TextSize = 24.000000
...
Frame24.BackgroundColor3 = Color3.fromRGB(25,25,30)
...
Frame27.Name = "Frame"
Frame27.Size = UDim2.new(1.000000,8,1.000000,8)
Frame27.Position = UDim2.new(0.000000,-4,0.000000,-4)
Frame27.AnchorPoint = Vector2.new(0.000000,0.000000)
Frame27.BackgroundColor3 = Color3.fromRGB(163,162,165)
Frame27.BackgroundTransparency = 1.000000
Frame27.BorderSizePixel = 1.000000
Frame27.Visible = false
Frame27.AutomaticSize = Enum.AutomaticSize.None
Frame27.ClipsDescendants = false
Frame27.LayoutOrder = 0.000000
Frame27.Parent = Frame24
local UICorner28 = Instance.new("UICorner")
UICorner28.CornerRadius = UDim.new(0.000000,16)
UICorner28.Parent = Frame27
local UIStroke29 = Instance.new("UIStroke")
UIStroke29.Color = Color3.fromRGB(255,255,255)
UIStroke29.Thickness = 2.000000
UIStroke29.Transparency = 0.300000
UIStroke29.ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual
UIStroke29.Parent = Frame27
local UIGradient30 = Instance.new("UIGradient")
UIGradient30.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(60,0,180)), ColorSequenceKeypoint.new(0.500000, Color3.fromRGB(120,0,220)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(60,0,180))})
UIGradient30.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000000, 0.850000, 0.000000), NumberSequenceKeypoint.new(0.200000, 0.200000, 0.000000), NumberSequenceKeypoint.new(0.800000, 0.200000, 0.000000), NumberSequenceKeypoint.new(1.000000, 0.850000, 0.000000)})
UIGradient30.Rotation = 0.000000
UIGradient30.Offset = Vector2.new(0.000000,0.000000)
UIGradient30.Parent = UIStroke29
...
TextBox31.TextSize = 16.000000
TextBox31.Font = Enum.Font.GothamBold
...
TextLabel32.Size = UDim2.new(0.000000,80,0.000000,20)
TextLabel32.Position = UDim2.new(1.000000,-85,0.000000,60)
...
TextLabel32.ZIndex = 13.000000
TextLabel32.Rotation = 0.000000
TextLabel32.Transparency = 1.000000
TextLabel32.Text = "0/44"
TextLabel32.TextColor3 = Color3.fromRGB(140,140,150)
TextLabel32.TextSize = 12.000000
TextLabel32.Font = Enum.Font.GothamBold
TextLabel32.TextScaled = false
TextLabel32.TextWrapped = false
...
Frame35.Name = "Frame"
Frame35.Size = UDim2.new(0.000000,24,0.000000,24)
Frame35.Position = UDim2.new(0.500000,-12,0.000000,12)
Frame35.AnchorPoint = Vector2.new(0.000000,0.000000)
Frame35.BackgroundColor3 = Color3.fromRGB(163,162,165)
Frame35.BackgroundTransparency = 1.000000
Frame35.BorderSizePixel = 1.000000
Frame35.Visible = false
Frame35.AutomaticSize = Enum.AutomaticSize.None
Frame35.ClipsDescendants = false
Frame35.LayoutOrder = 0.000000
Frame35.Parent = TextButton33
local Frame36 = Instance.new("Frame")
Frame36.Name = "Frame"
Frame36.Size = UDim2.new(1.000000,0,1.000000,0)
Frame36.Position = UDim2.new(0.000000,0,0.000000,0)
Frame36.AnchorPoint = Vector2.new(0.000000,0.000000)
Frame36.BackgroundColor3 = Color3.fromRGB(220,220,225)
Frame36.BackgroundTransparency = 0.000000
Frame36.BorderSizePixel = 0.000000
Frame36.Visible = true
Frame36.AutomaticSize = Enum.AutomaticSize.None
Frame36.ClipsDescendants = false
Frame36.LayoutOrder = 0.000000
Frame36.Parent = Frame35
local UICorner37 = Instance.new("UICorner")
UICorner37.CornerRadius = UDim.new(1.000000,0)
UICorner37.Parent = Frame36
local UIGradient38 = Instance.new("UIGradient")
UIGradient38.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(255,255,255)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(255,255,255))})
UIGradient38.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000000, 0.000000, 0.000000), NumberSequenceKeypoint.new(0.800000, 0.800000, 0.000000), NumberSequenceKeypoint.new(1.000000, 1.000000, 0.000000)})
UIGradient38.Rotation = 0.000000
UIGradient38.Offset = Vector2.new(0.000000,0.000000)
UIGradient38.Parent = Frame36
local Frame39 = Instance.new("Frame")
Frame39.Name = "Frame"
Frame39.Size = UDim2.new(1.000000,8,1.000000,8)
Frame39.Position = UDim2.new(0.000000,-4,0.000000,-4)
...
Frame39.BorderSizePixel = 1.000000
...
Frame39.Parent = TextButton33
local UICorner40 = Instance.new("UICorner")
UICorner40.CornerRadius = UDim.new(0.000000,14)
UICorner40.Parent = Frame39
local UIStroke41 = Instance.new("UIStroke")
UIStroke41.Color = Color3.fromRGB(255,255,255)
UIStroke41.Thickness = 2.000000
UIStroke41.Transparency = 0.300000
UIStroke41.ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual
UIStroke41.Parent = Frame39
local UIGradient42 = Instance.new("UIGradient")
UIGradient42.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(60,0,180)), ColorSequenceKeypoint.new(0.500000, Color3.fromRGB(120,0,220)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(60,0,180))})
UIGradient42.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000000, 0.850000, 0.000000), NumberSequenceKeypoint.new(0.200000, 0.200000, 0.000000), NumberSequenceKeypoint.new(0.800000, 0.200000, 0.000000), NumberSequenceKeypoint.new(1.000000, 0.850000, 0.000000)})
UIGradient42.Rotation = 0.000000
UIGradient42.Offset = Vector2.new(0.000000,0.000000)
UIGradient42.Parent = UIStroke41
...
TextButton44.BackgroundColor3 = Color3.fromRGB(40,140,100)
...
TextButton44.TextSize = 14.000000
...
Frame46.Name = "Frame"
Frame46.Size = UDim2.new(1.000000,8,1.000000,8)
Frame46.Position = UDim2.new(0.000000,-4,0.000000,-4)
Frame46.AnchorPoint = Vector2.new(0.000000,0.000000)
Frame46.BackgroundColor3 = Color3.fromRGB(163,162,165)
Frame46.BackgroundTransparency = 1.000000
Frame46.BorderSizePixel = 1.000000
Frame46.Visible = false
Frame46.AutomaticSize = Enum.AutomaticSize.None
Frame46.ClipsDescendants = false
Frame46.LayoutOrder = 0.000000
Frame46.Parent = TextButton44
local UICorner47 = Instance.new("UICorner")
UICorner47.CornerRadius = UDim.new(0.000000,14)
UICorner47.Parent = Frame46
local UIStroke48 = Instance.new("UIStroke")
UIStroke48.Color = Color3.fromRGB(255,255,255)
UIStroke48.Thickness = 2.000000
UIStroke48.Transparency = 0.300000
UIStroke48.ApplyStrokeMode = Enum.ApplyStrokeMode.Contextual
UIStroke48.Parent = Frame46
local UIGradient49 = Instance.new("UIGradient")
UIGradient49.Color = ColorSequence.new({ColorSequenceKeypoint.new(0.000000, Color3.fromRGB(60,0,180)), ColorSequenceKeypoint.new(0.500000, Color3.fromRGB(120,0,220)), ColorSequenceKeypoint.new(1.000000, Color3.fromRGB(60,0,180))})
UIGradient49.Transparency = NumberSequence.new({NumberSequenceKeypoint.new(0.000000, 0.850000, 0.000000), NumberSequenceKeypoint.new(0.200000, 0.200000, 0.000000), NumberSequenceKeypoint.new(0.800000, 0.200000, 0.000000), NumberSequenceKeypoint.new(1.000000, 0.850000, 0.000000)})
UIGradient49.Rotation = 0.000000
UIGradient49.Offset = Vector2.new(0.000000,0.000000)
UIGradient49.Parent = UIStroke48
